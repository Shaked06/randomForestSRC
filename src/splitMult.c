  ...
  if (preliminaryResult) {
    ...
    while (selectRandomCovariates(treeID,
      ...
      if (splitVectorSize >= 2) {
        ...
        //    for (r = 1; r <= RF_ytry; r++) {
        //      RF_nativePrint("%10d %10d ", r, pseudoResponse[r]);
        //    }
        //  }
  ...
  if (preliminaryResult) {
    ...
    while (selectRandomCovariates(treeID,
      ...
      if (splitVectorSize >= 2) {
        ...
        //              RF_nativePrint("\nImpurity:  ");
        //              for (r=1; r <= RF_ytry; r++) {
        //                RF_nativePrint(" %10d", pseudoResponse[r]);
        //              }
        //              RF_nativePrint("\n          ");
        //              for (r=1; r <= RF_ytry; r++) {
        //                RF_nativePrint( "%10d,", impurity[r]);
        //              }
        //            }
        //          }
        if (impuritySummary) {
                  ...
                  if (impurity[r]) {
                    ...
                    if ((secondNonMissMembrLeftSize[r] > 0) && (secondNonMissMembrRghtSize[r] > 0)) {
                      ...
                      if ((RF_rType[response[r]] == 'B') ||
                        ...
                        //                       mean[r],
                        //                       variance[r],
                        //                       RF_rFactorSize[RF_rFactorMap[response[r]]],
                        //                       partialLeft,
                        //                       partialRght,
                        //                       partialLeft+partialRght);
                        //            }
